...
export const translations = {
  fr: {
    ...
    waitlist: {
      ...
      // Step descriptions
      emailStepDescription: 'Indiquez votre adresse e-mail, votre code postal et comment vous avez entendu parler de nous.',
      ...
      hearAboutOptions: {
        ...
        tiktok: 'TikTok',
        youtube: 'YouTube',
        referral: 'Recommandation d’un ami ou de la famille',
        member: 'Recommandation d’un membre',
        search: 'Moteur de recherche (Google, etc.)',
        elle: 'Magazine ELLE / article',
        press: 'Autre article de presse ou blog',
        event: 'Événement ou partenariat',
        local: 'Bouche à oreille / quartier',
        ads: 'Publicité (en ligne ou imprimée)',
        newsletter: 'Newsletter ou e-mail',
      },
    ...
    privacy: {
      ...
      section7Content: 'Notre site web utilise des cookies pour améliorer votre expérience de navigation. Vous pouvez configurer votre navigateur pour refuser les cookies, mais cela peut affecter certaines fonctionnalités du site.',
  ...
  en: {
    ...
    waitlist: {
      ...
      stepVerify: 'Verify',
      // Step descriptions
      emailStepDescription: 'Enter your email address, postal code, and how you heard about us.',
      ...
      hearAboutOptions: {
        ...
        search: 'Search engine (Google, etc.)',
        elle: 'ELLE magazine or article',
        press: 'Other press article or blog',
        event: 'Event or partnership',
        local: 'Word of mouth / neighbourhood',
        ads: 'Advertising (online or print)',
    ...
    privacy: {
      ...
      section7Title: '7. Cookies',
      section7Content: 'Our website uses cookies to enhance your browsing experience. You can configure your browser to refuse cookies, but this may affect some website functionality.',
      section8Title: '8. Modifications',
